...
class LcReportScreenM extends StatefulWidget {
  static const routeName = '/mLc report';

  const LcReportScreenM({super.key});

  @override
  State<LcReportScreenM> createState() => _LcReportScreenMState();
}

class _LcReportScreenMState extends State<LcReportScreenM> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: lcList.isNotEmpty?Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          mainAxisAlignment: MainAxisAlignment.start,
          children: [
            Expanded(
              flex: isSecondSegmentVisible?(isThirdSegmentVisible?2:1):2,
              child: ListView.builder(
                itemCount: lcList.length,
                scrollDirection: isSecondSegmentVisible?Axis.horizontal:Axis.vertical,
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      height: 100,
                      width: 320,
                      padding: isSecondSegmentVisible? const EdgeInsets.all(8):const EdgeInsets.symmetric(horizontal: 10,vertical: 10),
                      child: ListTile(
                              ...
                              child: SingleChildScrollView(
                                child: GridView.builder(
                                  ...
                                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                    crossAxisCount: isThirdSegmentVisible ? 3 : 3,
                                    childAspectRatio: isThirdSegmentVisible ? 1 : 1,
                                  ),
